...
//
  ...
  G4SubtractionSolid* Concrete_S= new G4SubtractionSolid("boratedwater", Main_S_1, hole_S_1, NO_ROT, G4ThreeVector(0., -Water_cylindercal_can_radius/2.0+NeutronFilter_length/2.0, 0.0));
